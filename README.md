...
Task at hand  is a research project on employees of a major corporation from the 1980s and 1990s. All that remain of the database of employees from that period are six CSV files.
...
#### Data Analysis
When the database is complete, do the following:
